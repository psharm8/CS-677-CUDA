...
//////////////////////////////////////////////////////////////////////////////
    ...
    template<class T>
    bool
    nocutWriteFile( const char* filename, const T* data, unsigned int height, unsigned int width,
                  const T epsilon, bool verbose) 
    {
        ...
        // write data
		/*for (unsigned int i = 0; (i < height*width) && (fh.good()); ++i)
		{
			fh << data[i] << ' ';
		}*/
		for (unsigned int j = 0; j < height; ++j)
		{
			for (unsigned int i = 0; (i < width) && (fh.good()); ++i)
			{
				fh << data[j*width+i] << ' ';
			}
			fh << std::endl;
...
////////////////////////////////////////////////////////////////////////////////
bool
nocutWriteFilef( const char* filename, const float* data, unsigned int height, unsigned int width,
               const float epsilon, bool verbose=false) 
{
    return nocutWriteFile( filename, data, height, width, epsilon, verbose);
}
